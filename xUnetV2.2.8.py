...
batch_size=64 #always in 2^N compatible. Warning: Dont forget to write a batch size to saved parameters filenames!!!
...
file="epoch_200_err_0.4406062066555023_Unet1v1Params.pth" # change the name of the file that you want to load from

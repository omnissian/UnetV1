...
#---------------------------------------------------bottom-----------------------------------
        ...
        self.conv2d61=nn.Conv2d(in_channels=features*16+features*8,out_channels=features*8, kernel_size=3,stride=1,padding=3)
        self.conv2d62=nn.Conv2d(in_channels=features*8,out_channels=features*8, kernel_size=3,stride=1,padding=3)
        ...
        self.conv2d71=nn.Conv2d(in_channels=384,out_channels=128, kernel_size=3,stride=1,padding=3)
        self.conv2d72=nn.Conv2d(in_channels=128,out_channels=128, kernel_size=3,stride=1,padding=3)
        ...
        self.conv2d81=nn.Conv2d(in_channels=192,out_channels=64, kernel_size=3,stride=1,padding=3)
        self.conv2d81=nn.Conv2d(in_channels=64,out_channels=64, kernel_size=3,stride=1,padding=3)

        self.conv2d91=nn.Conv2d(in_channels=64,out_channels=3, kernel_size=3,stride=1,padding=3)
